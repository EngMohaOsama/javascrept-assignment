...
function popup() {
    ...
    text.textContent = "Welcome To Elzero Web Study";
    btn.textContent = "X";
    ...
    parent.style.cssText = "background-color: #eee; border: 1px solid #ccc; padding 20px; text-align: center; position: relative; width: 350px; height: 150px; margin: 20px auto; position: fixed; top: 30%; left: 30%";
